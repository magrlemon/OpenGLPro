...
//
//	pBits = (BYTE*)(gltReadBMPBits(szFileName, &iWidth, &iHeight));
//	if(pBits == NULL)
//		return false;
//
//	// Set Wrap modes
...
//	LoadBMPTexture("..\\GLProgram\\hdr_bloom\\marble.bmp", GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, GL_REPEAT);
//
...
//    LoadOpenEXRImage("..\\GLProgram\\hdr_bloom\\window.exr", windowTexture, texWidth, texHeight);
//
//	// Load flat color shader
//	flatColorProg =  gltLoadShaderPairWithAttributes("..\\GLProgram\\hdr_bloom\\basic.vs", "..\\GLProgram\\hdr_bloom\\color.fs", 3, 
...
//	texReplaceProg =  gltLoadShaderPairWithAttributes("..\\GLProgram\\hdr_bloom\\basic.vs", "..\\GLProgram\\hdr_bloom\\tex_replace.fs", 3, 
//							GLT_ATTRIBUTE_VERTEX, "vVertex", 
//							GLT_ATTRIBUTE_NORMAL, "vNormal", 
//							GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");
...
//
//	// Load bloom shader
//	hdrBloomProg =  gltLoadShaderPairWithAttributes("..\\GLProgram\\hdr_bloom\\basic.vs", "..\\GLProgram\\hdr_bloom\\hdr_exposure.fs", 3, 
//							GLT_ATTRIBUTE_VERTEX, "vVertex", 
//							GLT_ATTRIBUTE_NORMAL, "vNormal", 
//							GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");
...
//
//	// Load blur shader
//	blurProg =  gltLoadShaderPairWithAttributes("..\\GLProgram\\hdr_bloom\\basic.vs", "..\\GLProgram\\hdr_bloom\\blur.fs", 2,
//							GLT_ATTRIBUTE_VERTEX, "vVertex", 
//							GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");
